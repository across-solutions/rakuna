...
<head>
	...
	<?php echo Asset::js('smoothScroll.js'); ?>
...
<body id="top">
	<?php include_once(DOCROOT.'/assets/order/images/svg/icons.svg'); ?>
	...
	<div class="content">
		...
		<div class="contentWrapper">
			...
			<?php echo Presenter::forge('parts/category'); ?>

			<?php echo Presenter::forge('parts/menu'); ?>
