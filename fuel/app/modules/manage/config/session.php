...
return array(
	...
	*/
	...
	'cookie'			=> array(
		'cookie_name'		=> 'managecid',				// name of the session cookie for cookie based sessions
						),

	// specific configuration settings for file based sessions
	'file'				=> array(
		'cookie_name'		=> 'managefid',				// name of the session cookie for file based sessions
		'path'				=>	APPPATH . 'cache/session',					// path where the session files should be stored
