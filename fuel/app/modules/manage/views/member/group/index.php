...
<div class="mainMenuWrap">
	...
	<div class="mainMenu">
		<ul>
			<li>
				<a href="/manage/member/group/add" class="dialog" title="グループを追加">
					<span class="icon-chevron-right mr"></span>グループを追加<span class="icon-plus abss"></span>
				</a>
			</li>
		</ul>
	</div>
...
<?php echo Form::open(array('action' => '/manage/member/group', 'method' => 'get')); ?>
	<!--#search start -->
	<div class="search">
		<p>
		検索条件を指定して検索してください
...
<?php if ($data_count > 0) : ?>
	...
	<div class="list">
		...
		<table class="resultList stripe">
			<thead>
				<tr>
					<th class="w15">グループコード</th>
					<th class="w45">グループ名</th>
					<th class="w8">編集</th>
				</tr>
			</thead>
			<tbody>
				<?php foreach($rows as $row) : ?>
					<tr>
						<td class="center">
							<a href="/manage/member/group/edit/<?php echo Arr::get($row, 'id'); ?>" class="dialog">
