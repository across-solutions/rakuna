...
<?php echo Form::open('/manage/member/group/add_save'); ?>
	<?php echo $message(); ?>
	<!--#dig edit form start -->
	<div class="digEditForm clearfix">
		...
		<div class="digForm">
			...
			<dl class="clearfix">
				...
				<dd>
					<?php echo Form::input('code', Input::post('code'), array('id' => 'catCode', 'placeholder' => '0000000000000')); ?>
			...
			<dl class="clearfix">
				...
				<dd>
					<?php echo Form::input('name', Input::post('name'), array('id' => 'catName', 'placeholder' => 'サンプルグループ名')); ?>
