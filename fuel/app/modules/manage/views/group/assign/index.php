...
<div class="mainMenuWrap">
	...
	<div class="mainMenu">
		<ul>
			<li>
				<a href="/manage/group/assign/add" title="割当を追加" class="dialog">
					<span class="icon-chevron-right mr"></span>割当を追加<span class="icon-plus abss"></span>
				</a>
			</li>
			<li>
				<a href="/manage/group/assign/upload_csv" title="CSVアップロード" class="dialog">
...
<?php echo Form::open(array('action' => '/manage/group/assign', 'method' => 'get')); ?>
	<!--#search start -->
	<div class="search">
		<p>
			検索条件を指定して検索してください
		...
		<table class="searchBox">
			<tbody>
				<tr>
					...
					<td>
						<?php echo Form::input('member_group_code', Input::get('member_group_code')); ?>
...
<?php if ($data_count > 0) : ?>
	...
	<div class="subMenuWrap">
		...
		<div class="subMenu">
			<ul>
				<li>
					<a href="/manage/group/assign/download_csv<?php echo Common_Util::get_query_string(); ?>" title="CSVダウンロード" class="dialog w180">
	...
	<div class="list">
		...
		<table class="resultList stripe">
			<thead>
				<tr>
					<th class="w10">グループコード</th>
					<th class="w20">グループ名</th>
			...
			<tbody>
				<?php foreach($rows as $row) : ?>
					<tr>
						<td class="center">
							<?php echo Arr::get($row, 'member_group_code'); ?>
						</td>
						<td class="left">
							<?php echo Arr::get($row, 'member_group_name'); ?>
						</td>
						<td class="center">
						...
						<td class="center">
							<a href="/manage/group/assign/edit/<?php echo Arr::get($row, 'id'); ?>" class="dialog">
