...
<?php echo Form::open(array('action' => '/manage/item/pr/upload_csv_save', 'enctype' => 'multipart/form-data')); ?>
	<!--#dig edit form start -->
	<div class="digEditForm clearfix">
		...
		<div class="digForm">
			...
			<dl class="clearfix">
				...
				<dd>
					<?php echo Form::file('pr_item_csv', array('id' => 'itemPrCsv')); ?>
		...
		<div class="digForm">
			...
			<div class="errorResult">
				<?php if($validate_error('pr_item_csv')) : ?>
					<?php echo $validate_error_message('pr_item_csv'); ?>
