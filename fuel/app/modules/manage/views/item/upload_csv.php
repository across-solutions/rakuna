...
<?php echo Form::open(array('action' => '/manage/item/upload_csv_save', 'enctype' => 'multipart/form-data')); ?>
	<!--#dig edit form start -->
	<div class="digEditForm clearfix">
		...
		<div class="digForm">
			...
			<dl class="clearfix">
				...
				<dd>
					<?php echo Form::file('item_csv', array('id' => 'itemCsv')); ?>
		...
		<div class="digForm">
			...
			<div class="errorResult">
				<?php if($validate_error('item_csv')) : ?>
					<?php echo $validate_error_message('item_csv'); ?>
