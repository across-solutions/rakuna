<div class="normal">
	...
	<?php echo Form::open(array('action' => '/manage/item/order/type/upload_csv_save', 'enctype' => 'multipart/form-data')); ?>
		<!--#dig edit form start -->
		<div class="digEditForm clearfix">
			...
			<div class="digForm">
				...
				<dl class="clearfix">
					<dt>
						<label for="itemOrderTypeCsv">
						CSVファイル<span class="red">*</span>
						</label>
					</dt>
					<dd>
						<?php echo Form::file('item_order_type_csv', array('id' => 'itemOrderTypeCsv')); ?>
			...
			<div class="digForm">
				...
				<div class="errorResult">
					<?php if($validate_error('item_order_type_csv')) : ?>
						<?php echo $validate_error_message('item_order_type_csv'); ?>
