...
<div class="mainMenuWrap">
	...
	<div class="mainMenu">
		<ul>
			<li>
				<a href="/manage/item/assign/add" title="割当を追加" class="dialog">
					<span class="icon-chevron-right mr"></span>割当を追加<span class="icon-plus abss"></span>
				</a>
			</li>
			<li>
				<a href="/manage/item/assign/upload_csv" title="CSVアップロード" class="dialog">
...
<?php echo Form::open(array('action' => '/manage/item/assign', 'method' => 'get')); ?>
	<!--#search start -->
	<div class="search">
		<p>
		検索条件を指定して検索してください
...
<?php if ($data_count > 0) : ?>
	...
	<div class="subMenuWrap">
		...
		<div class="subMenu">
			<ul>
				<li>
					<a href="/manage/item/assign/download_csv<?php echo Common_Util::get_query_string(); ?>" title="CSVダウンロード" class="dialog w180">
