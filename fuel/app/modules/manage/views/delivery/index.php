...
<div class="mainMenuWrap">
	...
	<div class="mainMenu">
		<ul>
			<li>
				<a href="/manage/delivery/add" class="dialog" title="納品先を追加">
					<span class="icon-chevron-right mr"></span>納品先を追加<span class="icon-plus abss"></span>
				</a>
			</li>
			<li>
				<a href="/manage/delivery/upload_csv" title="CSVアップロード" class="dialog">
...
<?php echo Form::open(array('action' => '/manage/delivery', 'method' => 'get')); ?>
	<!--#search start -->
	<div class="search">
		<p>
		検索条件を指定して検索してください
...
<?php if ($data_count > 0) : ?>
	...
	<div class="subMenuWrap">
		...
		<div class="subMenu">
			<ul>
				<li>
					<a href="/manage/delivery/download_csv<?php echo Common_Util::get_query_string(); ?>" title="CSVダウンロード" class="dialog w180">
		...
		<table class="resultList stripe">
			...
			<tbody>
				...
				<?php $id = Arr::get($row, 'id'); ?>
					<tr>
						<td class="center">
							<?php echo Arr::get($row, 'members.code'); ?>
						</td>
						<td class="left">
							<?php echo Arr::get($row, 'members.name'); ?>
						</td>
						<td class="center">
							<a href="/manage/delivery/edit/<?php echo Arr::get($row, 'id'); ?>" class="dialog">
