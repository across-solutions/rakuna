...
<?php echo Form::open('/manage/recommended/group/edit_save', array('id' => Arr::get($data, 'id'))); ?>
	<?php echo $message(); ?>
	<!--#dig edit form start -->
	<div class="digEditForm clearfix">
		...
		<div class="digForm">
			...
			<dl class="clearfix">
				...
				<dd>
					<?php echo Form::input('name', Arr::get($data, 'name'), array('id' => 'catName', 'placeholder' => 'サンプルいつものグループ名')); ?>
	...
	<div class="digNav">
		<ul>
			...
			<li>
				<a href="/manage/recommended/group/delete_save" title="削除" class="submit_delete">
