...
<?php echo Form::open(array('action' => '/manage/recommended/group/assign/upload_csv_save', 'enctype' => 'multipart/form-data')); ?>
	<!--#dig edit form start -->
	<div class="digEditForm clearfix">
		...
		<div class="digForm">
			...
			<dl class="clearfix">
				...
				<dd>
					<?php echo Form::file('recommended_group_assign_csv', array('id' => 'assignCsv')); ?>
		...
		<div class="digForm">
			...
			<div class="errorResult">
				<?php if($validate_error('recommended_group_assign_csv')) : ?>
					<?php echo $validate_error_message('recommended_group_assign_csv'); ?>
