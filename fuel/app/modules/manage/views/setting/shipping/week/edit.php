...
<?php echo Form::open('/manage/setting/shipping/week/edit_save', array('id' => Arr::get($data, 'id'))); ?>
	<?php echo $message(); ?>
	<!--#dig edit form start -->
	...
	<div class="digNav">
		<ul>
			...
			<li>
				<a href="/manage/setting/shipping/week/delete_save" title="削除" class="submit_delete">
