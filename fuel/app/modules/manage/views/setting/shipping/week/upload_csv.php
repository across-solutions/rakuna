...
<?php echo Form::open(array('action' => '/manage/setting/shipping/week/upload_csv_save', 'enctype' => 'multipart/form-data')); ?>
	<!--#dig edit form start -->
	<div class="digEditForm clearfix">
		...
		<div class="digForm">
			...
			<dl class="clearfix">
				<dt>
					<label for="deliveryWeekCsv">
						CSVファイル<span class="red">*</span>
					</label>
				</dt>
				<dd>
					<?php echo Form::file('delivery_week_csv', array('id' => 'deliveryWeekCsv')); ?>
		...
		<div class="digForm">
			...
			<div class="errorResult">
				<?php if($validate_error('delivery_week_csv')) : ?>
					<?php echo $validate_error_message('delivery_week_csv'); ?>
