...
<div class="mainMenuWrap">
	...
	<div class="mainMenu">
		<ul>
			<li>
				<a href="/manage/order/confirm<?php echo Common_Util::get_query_string(); ?>" title="受注確定" class="dialog">
					<span class="icon-chevron-right mr"></span>受注確定<span class="icon-download abss"></span>
				</a>
			</li>
		</ul>
	</div>
...
<?php echo Form::open(array('action' => '/manage/order', 'method' => 'get')); ?>
<!--#search start -->
<div class="search">
	<p>
		検索条件を指定して検索してください
			...
			<tbody>
				<?php foreach($rows as $row) : ?>
					<tr <?php if (Arr::get($row, 'cancel_flg')) : ?>class="delFlg"<?php endif; ?>>
						<td class="center">
							<?php if (Arr::get($row, 'cancel_flg')) : ?>
								<a href="/manage/order/view/<?php echo Arr::get($row, 'id'); ?>" class="dialog">
							<?php else : ?>
									<a href="/manage/order/edit/<?php echo Arr::get($row, 'id'); ?>" class="dialog">
							<?php endif; ?>
						...
						<td class="center">
							...
							<?php else : ?>
									<a href="/manage/order/edit/<?php echo Arr::get($row, 'id'); ?>" class="dialog" title="詳細を表示">
							<?php endif; ?>
